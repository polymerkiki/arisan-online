	...
	<div class="team py-5" id="agents">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row new-agileinfo">
				...
				<div id="demo1_main_image" class="col-lg-8 team-right" style="text-align: left;"><div class="desoSlide-wrapper"><img class="img-responsive animated fadeInLeft" style="opacity: 0;" src="images/t1.jpg" alt="" data-desoslide-caption="<h3>Carolyn Kylie</h3>  Eligendi optio nam libero tempore cum soluta nobis est cumque nihil impedit quo minus id quod maxime placeat facere possimus omnis optio cumque nihil impedit quo minus id quod maxime placeat facere possimus"><div class="desoSlide-overlay" style="left: 0px; top: 356px; width: 640px; opacity: 0.7;"><h3>Carolyn Kylie</h3>  Eligendi optio nam libero tempore cum soluta nobis est cumque nihil impedit quo minus id quod maxime placeat facere possimus omnis optio cumque nihil impedit quo minus id quod maxime placeat facere possimus</div><div class="desoSlide-controls-wrapper" style="width: 365px; left: -365px;"><a href="#prev"><span class="desoSlide-controls prev"></span></a><a href="#pause" style="display: none;"><span class="desoSlide-controls pause"></span></a><a href="#play"><span class="desoSlide-controls play"></span></a><a href="#next"><span class="desoSlide-controls next"></span></a></div></div></div>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="w3_testimonials_grids">
				<section class="slider">
					...
					<div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1000%; transition-duration: 0.6s; transform: translate3d(-1776px, 0px, 0px);"><li class="clone" style="width: 888px; float: left; display: block;">
							...
							<li style="width: 888px; float: left; display: block;" class="">
								<div class="w3_testimonials_grid">
									<p>"Nam Cumque nihil impedit quo minuslibero tempore, nihil impedit quo minus id quod possimus, Nam Cumque nihil impedit
										quo minuslibero tempore, cum soluta nobis est eligendi optio cumque nihil impedit omnis voluptas".</p>
									<ul class="testi-w3ls-rate mt-4">
							...
							<li style="width: 888px; float: left; display: block;" class="flex-active-slide">
								<div class="w3_testimonials_grid">
									<p>"Nam Cumque nihil impedit quo minuslibero tempore, nihil impedit quo minus id quod possimus, Nam Cumque nihil impedit
										quo minuslibero tempore, cum soluta nobis est eligendi optio cumque nihil impedit omnis voluptas".</p>
									<ul class="testi-w3ls-rate mt-4">
							...
							<li style="width: 888px; float: left; display: block;">
								<div class="w3_testimonials_grid">
									<p>"Nam Cumque nihil impedit quo minuslibero tempore, nihil impedit quo minus id quod possimus, Nam Cumque nihil impedit
										quo minuslibero tempore, cum soluta nobis est eligendi optio cumque nihil impedit omnis voluptas".</p>
									<ul class="testi-w3ls-rate mt-4">
						...
						<li style="width: 888px; float: left; display: block;" class="clone">
								<div class="w3_testimonials_grid">
									<p>"Nam Cumque nihil impedit quo minuslibero tempore, nihil impedit quo minus id quod possimus, Nam Cumque nihil impedit
										quo minuslibero tempore, cum soluta nobis est eligendi optio cumque nihil impedit omnis voluptas".</p>
									<ul class="testi-w3ls-rate mt-4">
							...
							</li></ul></div><ol class="flex-control-nav flex-control-paging"><li><a class="">1</a></li><li><a class="flex-active">2</a></li><li><a>3</a></li></ol><ul class="flex-direction-nav"><li><a class="flex-prev" href="#">Previous</a></li><li><a class="flex-next" href="#">Next</a></li></ul></div>
				</section>
...
<a href="#" id="toTop" style="display: none;"><span id="toTopHover"></span>To Top</a><img src="file:///C:/Users/fahri/Desktop/arisan/images/t1.jpg" alt="" style="display: none;"><img src="file:///C:/Users/fahri/Desktop/arisan/images/t2.jpg" alt="" style="display: none;"><img src="file:///C:/Users/fahri/Desktop/arisan/images/t3.jpg" alt="" style="display: none;"><img src="file:///C:/Users/fahri/Desktop/arisan/images/t4.jpg" alt="" style="display: none;"></body></html>